...
#	strip.setPixelColor(n, colourArray[c][1], colourArray[c][3], colourArray[c][2])

#last updated on pi-four - merged with pi-one's colourArray
...
ticktock(3, 5, getColour("green"), getColour("blue"))

print(" transition -chasePixels - red - green")
setInbetween(2)
chasePixels(120, -5, -10, getColour("blue"), getColour("green"))
...
setInbetween(2)
print("chase with no tail - blue/green")
chaseRandomPixels(5, 0,getColour("green"), getColour("blue"))
