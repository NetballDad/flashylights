...
switch (lights) {
        case 1: splitPixels(getColour("blue"));
            break;
        case 2: ticktock(3, 5, getColour("blue"), getColour("white"))
            break;
        case 3: chasePixels(120, -5, -10, getColour("white"), getColour("blue"))
            break;
        case 4: chaseRandomPixels(5, 1, getColour("White"), getColour("blue"))
            break;
        case 5: setAllPixels("blue")
                flashLights(0.5)
                break;
        case 6: setAllPixels("white")
                flashLights(0.5)
                break;
}